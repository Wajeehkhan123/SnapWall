...
$('#printButton').on('click',function(){
    ...
    function gotOrderData(data){
        ...
        for(var i = 0; i < keys.length; i++){
            ...
            var submainChuss ="<div id=\""+getData[k].key+"\" class=\" printDetail \"><h3 class=\"inner-title text-center\">\ Order Id = "+getData[k].key+" \</h3><hr><h4 class=\"inner-title\">\ Placement Date\</h4><p class=\"category\">"+getData[k].placement_date+"</p><h4 class=\"inner-title\">\ Expected Arrival\</h4><p class=\"category\">"+getData[k].expected_arrival+"</p><h4 class=\"inner-title\">\ Price\ </h4><p class=\"category\">"+getData[k].price+"</p><h4 class=\"inner-title\">\ Status\</h4><p class=\"category\">"+getData[k].status+"</p><h4 class=\"inner-title\">\ Shipping Province\</h4><p class=\"category\">"+getData[k].shipping_province+"</p><h4 class=\"inner-title\">\ City\ </h4><p class=\"category\">"+getData[k].shipping_city+"</p><h4 class=\"inner-title\">\ Shipping Address\ </h4><p class=\"category\">"+getData[k].shipping_address+"</p><h4 class=\"inner-title\">\ Zip Code\ </h4><p class=\"category\">"+getData[k].shipping_zipcode+"</p><h4 class=\"inner-title\">\ User Id\</h4><p class=\"category\">"+getData[k].user_id+"</p><h4 class=\"inner-title\">\ Order Images\</h4><hr><div class=\ row \ ><div class=\ col-md-4 \ >"+"<a href=\""+images[0]+"\"  download>"+"<img class=\"img-fluid\" style=\"height:300px;width:300px; margin: 1em; \" src=\""+images[0]+"\"></a></div><div class=\ col-md-4 \ >"+"<a href=\""+images[1]+"\" download>"+"<img class=\"img-fluid\" style=\"height:300px;width:300px; margin: 1em; \" src=\""+images[1]+"\"></a></div><div class=\ col-md-4 \ >"+"<a href=\""+images[2]+"\" download>"+"<img class=\"img-fluid\" style=\"height:300px;width:300px; margin: 1em; \" src=\""+images[2]+"\"></a></div></div><button type=\"button\" style=\"margin-bottom: 0.5em;\" class=\"btn btn-primary text-center confirm-btn\"><i class=\"fas fa-check\"></i>\ Confirm \ </button></div><hr><br>"; 
